...
def build_fms_assets():
    ...
    if nav_row and nav_row[1]:
        ...
        os.makedirs("web-dashboard/public/maps", exist_ok=True)
        with open("web-dashboard/public/maps/fms_map.png", "wb") as f:
            f.write(img_data)
        print("Saved map image to web-dashboard/public/maps/fms_map.png")
    ...
    # Save layout
    with open("web-dashboard/public/maps/warehouse_layout.json", "w") as f:
        json.dump(layout, f, indent=2)
    with open("backend/warehouse_layout.json", "w") as f:
        json.dump(layout, f, indent=2)

    print("Successfully built warehouse_layout.json!")
